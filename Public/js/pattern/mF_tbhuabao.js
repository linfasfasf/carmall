...
myFocus.extend({//*********************tbhuabao******************
    mF_tbhuabao:function(par,F){
        ...
        pics.innerHTML+=pics.innerHTML;//鏃犵紳澶嶅埗
        for(var i=0;i<n;i++) dot[i].innerHTML='<a href="javascript:;">&bull;</a>';//灏忕偣
        pre.innerHTML='<a href="javascript:;">&#8249;</a>';nex.innerHTML='<a href="javascript:;">&#8250;</a>';//鍓嶅悗绠ご
        //CSS
        ...
        for(var i=0;i<2*n;i++) pic[i].style.cssText='width:'+par.width+'px;height:'+par.height+'px;';//婊戝姩鍥哄畾鍏跺ぇ灏�
...
myFocus.set.params('mF_tbhuabao',{less:true});//鏀寔鏃犵紳璁剧疆